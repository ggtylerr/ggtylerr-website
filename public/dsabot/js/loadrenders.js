...
function render() {
        ...
        '{{#command}}',
          '<div class="command">',
            ...
            '<span id="{{name}}-details" style="display:none;">',
              ...
              '{{/details}}',
              '{{#picname}}',
                '<img src="/dsabot/imgs/{{picname}}.png" alt="Example Usage" class="fit"/>',
              '{{/picname}}',
              '{{^picname}}',
                '<img src="/dsabot/imgs/{{name}}.png" alt="Example Usage" class="fit"/>',
              '{{/picname}}',
            '</span>',
          '</div>',
          '<br/>',
  ...
  $.getJSON("/dsabot/commands.json",data=>document.getElementById('cmds').innerHTML=Mustache.render(template,data));
